...
export const logsSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    segmentId,
    title: 'Search Bar',
    description: `This is your <b>log console</b>, from here you will be able to see all of your <b>execution logs</b> and the <b>context/data</b> you provide with your logs.<br/><br/>As you develop your flows and test them, your logs will grow over time. This is when the search bar comes in handy, using the search bar you can narrow down your log search.`,
    id: uuidv4(),
  },
  {
  ...
  },
  {
    ...
    id: uuidv4(),
    requiredSelectorOnPrev: `//div[@data-testid="logs-search-container"]`,
    clickRequireSelectorMissingOnPrev: [
      { target: '//button[@data-testid="logs-link"]', useKeyDown: true },
      { target: `(//td[starts-with(@data-testid, 'trace')])[1]` },
    ],
