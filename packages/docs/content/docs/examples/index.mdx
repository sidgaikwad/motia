...
<Cards>
  ...
  <Card
    ...
    description="Build a human-in-the-loop content moderation system with AI analysis and Slack integration"
  />
  <Card
    title="GitHub Stars Counter"
    href="/docs/examples/github-stars-counter"
    description="Production-grade real-time GitHub stars counter powering Motia.dev - secure webhooks, live streaming, enterprise scale"
  />
</Cards>
